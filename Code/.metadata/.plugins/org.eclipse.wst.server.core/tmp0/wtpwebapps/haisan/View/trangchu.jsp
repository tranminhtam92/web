...
<body>
	<div id="wrapper">
		<div id="header">
			...
			<img class="slogan" src="../hinhanh/slogan.jpg"> 
			<img class="sdt" src="../hinhanh/sdt.png">
		</div>
		<div id="nav">
		 	<a href="#">Trang chủ</a>
			<a href="#">Lien he</a>
		...
		<div id="footer">
			<h3>Thong tin lien he</h3><a href="#"><img src="../hinhanh/logofb.jpg"> </a>

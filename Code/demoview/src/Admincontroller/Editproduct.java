...
public class Editproduct extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (ConnectDB.getconnectDB(username, password)) {
			...
			if(flag){
				spDAO.updatesanpham(masp, tensp, gia, donvitinh, soluong, mota, anh, ngay, maloai, khuyenmai, sanphammoi);
			}
			else{
				spDAO.updatesanpham(masp, tensp, gia, donvitinh, soluong, mota, ngay, maloai, khuyenmai, sanphammoi);
			}
			//response.getWriter().append(masp);
			//response.getWriter().append(tensp);
			//response.getWriter().append("sửa");
			...
			/*writer.println(masp);
			writer.println(tensp);
			writer.println(soluong);
			writer.println(gia);
			writer.println(donvitinh);
			writer.println(anh);
			writer.println(mota);
			writer.println(ngay);
			writer.println(sanphammoi);
			writer.println(maloai);*/
